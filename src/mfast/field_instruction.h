...
union value_storage_t {
  ...
  value_storage_t()
  {
    array_storage.content_ = 0;
    array_storage.capacity_ = 0;
    array_storage.defined_bit_ = 0;
    array_storage.len_ = 0;
  };
  ...
  value_storage_t(int)
  {
    array_storage.content_ = 0;
    array_storage.capacity_ = 0;
    array_storage.defined_bit_ = 1;
    array_storage.len_ = 1;
  };
  ...
  public:
    template_instruction_ex(uint32_t    id,
      ...
      : template_instruction(id, name, ns, template_ns, dictionary,
                             subinstructions, subinstructions_count, typeref_name, typeref_ns)
    {
    }
