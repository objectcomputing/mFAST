  ...
  , storage_(storage_ptr_of(cref))
{
  ...
  case field_type_templateref:
    ...
    // if you hit the exeception, you have to use dynamic_message_mref.rebind() to bind a valid template_instruction
    // prior to this call(). If this is a static templateRef, please use the resolved templates provided by encoder or
    // those generated by fast_type_gen.
    break;
  default:
    instruction_ =0;
  }
