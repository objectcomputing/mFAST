...
namespace mfast {
  ...
  namespace detail {
    ...
    struct result_holder
    {
      ...
      void
      apply_visitor(Visitor& v, SimpleRef ref)
      {
        result_ = v.visit(ref);
      }
      ...
      void
      apply_visitor(Visitor& v, CompositeRef ref, int)
      {
    ...
    template <class FieldAccessor, class Result = decltype (static_cast<FieldAccessor*>(nullptr)->visit(int32_cref()) ) >
    ...
    template <class FieldMutator, class Result = decltype (static_cast<FieldMutator*>(nullptr)->visit(int32_mref()) )>
...
///////////////////////////////////////////////////////////
  ...
  apply_accessor( T& accessor, field_cref v)
  {
    ...
    v.instruction()->accept(adaptor,const_cast<mfast::value_storage *>(field_cref_core_access::storage_of(v)));
