  ...
  : mfast::detail::codec_helper
{
  ...
  template <typename T>
  void encode_field(const T &ext_ref, group_type_tag);

  template <typename T>
  void encode_field(const T &ext_ref, sequence_type_tag);


  template <typename T, typename TypeCategory>
  void encode_field (const T &ext_ref,
                     none_operator_tag,
                     TypeCategory);
...
template <typename T, typename TypeCategory>
inline void
fast_encoder_core::encode_field(const T& ext_ref, TypeCategory)
{
  this->encode_field(ext_ref,
...
template <typename T>
inline void
fast_encoder_core::encode_field(const T& ext_ref, split_decimal_type_tag)
{
...
template <typename T>
inline void fast_encoder_core::encode_field(const T& ext_ref, int_vector_type_tag)
{
...
template <typename T>
inline void
fast_encoder_core::encode_field(const T& ext_ref, group_type_tag)
{
...
template <typename T>
inline void
fast_encoder_core::encode_field(const T& ext_ref, sequence_type_tag)
{
...
template <typename T, typename TypeCategory>
void
fast_encoder_core::encode_field (const T& ext_ref,
                                 none_operator_tag,
                                 TypeCategory)
{
  strm_ << ext_ref;
