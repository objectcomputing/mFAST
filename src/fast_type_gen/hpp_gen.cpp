...
void hpp_gen::visit(const mfast::group_field_instruction* inst, void* pIndex)
{
  ...
  else
  {
    ...
    header_cref_ << "\n"
                 ...
                 << indent << "    " << name << "_cref(\n"
                 << indent << "      typename std::enable_if<std::is_same<typename T::cref_type, " << name << "_cref>::value, const mfast::value_storage*>::type storage,\n"
    ...
    header_mref_ << "\n"
                 ...
                 << indent << "      typename std::enable_if<std::is_same<typename T::cref_type, " << name << "_cref>::value, mfast::value_storage*>::type   storage,\n"
                 << indent << "      const T* instruction);\n\n"
