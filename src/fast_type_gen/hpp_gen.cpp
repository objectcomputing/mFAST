...
void hpp_gen::gen_primitive (const char* cpp_type, const mfast::field_instruction* inst)
{
  ...
  header_cref_ << indent << "mfast::"<< cpp_type << "_cref safe_get_" << name << "() const;\n";
...
void hpp_gen::visit(const mfast::group_field_instruction* inst, void* pIndex)
{
  ...
  if (cpp_type.size()) {
    ...
    if (pIndex) {
      ...
      header_cref_ << indent << name << "_cref safe_get_" << name << "() const;\n";
...
void hpp_gen::visit(const mfast::templateref_instruction* , void* pIndex)
{
  ...
  header_cref_ << indent << "mfast::nested_message_cref safe_get_nested_message" << index << "() const;\n";
